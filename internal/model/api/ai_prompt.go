...
type AiPrompt struct {
	...
	Severity              Severity      `jsonapi:"attribute" json:"severity"`                // severity of the finding (Datadog specific)
	Category              Category      `jsonapi:"attribute" json:"category"`                // category of the finding (Datadog specific)
	IsTesting             bool          `jsonapi:"attribute" json:"is_testing"`              // used for testing (Datadog specific)
	IsDefault             bool          `jsonapi:"attribute" json:"is_default"`              // default or custom rule
	Version               string        `jsonapi:"attribute" json:"rule_version"`            // rule version used in caching logic
	ResultKeywordsExclude []string      `jsonapi:"attribute" json:"result_keywords_exclude"` // keywords to filter false positive results
	FileSearchKeywords    []string      `jsonapi:"attribute" json:"file_search_keywords"`    // keywords to select files for analysis
}
