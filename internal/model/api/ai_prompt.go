...
type AiPrompt struct {
	...
	Severity              Severity      `jsonapi:"attribute" json:"severity"`                          // Datadog specific
	Category              Category      `jsonapi:"attribute" json:"category"`                          // Datadog specific
	IsTesting             bool          `jsonapi:"attribute" json:"is_testing"`                        // Datadog specific
	IsDefault             bool          `jsonapi:"attribute" json:"is_default"`                        // default or custom rule
	Version               string        `jsonapi:"attribute" json:"rule_version"`                      // rule version for caching
	ResultKeywordsExclude []string      `jsonapi:"attribute" json:"result_keywords_exclude,omitempty"` //nolint:lll
